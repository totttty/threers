//! Parity scene `rt` — native Rust (winit + wgpu).
//!
//! Generated from `tests/parity/scenes/threers-rt.html`.
//! Compare with the JavaScript tab above; adjust imports before copying to `examples/`.
//!
//! ```text
//! cargo run --example rt
//! ```
...
async fn run() {
    ...
    // const offscreen = new THREE.WebGLRenderTarget(256, 256);
