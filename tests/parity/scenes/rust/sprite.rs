//! Parity scene `sprite` — native Rust (winit + wgpu).
//!
//! Generated from `tests/parity/scenes/threers-sprite.html`.
...
async fn run() {
    ...
    scene.background = Color::from_hex(0x0c0c20);
    // const mat = new THREE.SpriteMaterial({ color: 0xffaa44 });
    // const s = new THREE.Sprite(mat);
    s.position = Vector3::new(0.0, 0.0, 0.0);
    s.scale = Vector3::new(0.6, 0.6, 0.6);
    scene.add(s);
