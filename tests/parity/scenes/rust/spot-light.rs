//! Parity scene `spot-light` — native Rust (winit + wgpu).
//!
//! Generated from `tests/parity/scenes/threers-spot-light.html`.
//! Compare with the JavaScript tab above; adjust imports before copying to `examples/`.
//!
//! ```text
//! cargo run --example spot_light
//! ```
