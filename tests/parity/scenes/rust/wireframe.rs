//! Parity scene `wireframe` — native Rust (winit + wgpu).
//!
//! Generated from `tests/parity/scenes/threers-wireframe.html`.
...
async fn run() {
    ...
    let mut ico = Object3D::mesh(Mesh::new(IcosahedronGeometry::new(1.1, 1.0), BasicMaterial::new(Color::from_hex(0x00ffaa)).wireframe(true).into()));
