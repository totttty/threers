...
async fn run() {
    ...
    scene.add(dl2);
    let mut sphere = Object3D::mesh(Mesh::new(SphereGeometry::new(1.1, 32, 16), StandardMaterial::new(Color::from_hex(0xffffff)).with_roughness(0.5).with_metalness(0.0).into()));
    scene.add(sphere);
