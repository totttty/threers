//! Parity scene `env-cube` — native Rust (winit + wgpu).
//!
//! Generated from `tests/parity/scenes/threers-env-cube.html`.
//! Compare with the JavaScript tab above; adjust imports before copying to `examples/`.
//!
//! ```text
//! cargo run --example env_cube
//! ```
