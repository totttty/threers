//! Parity scene `depth-mat` — native Rust (winit + wgpu).
//!
//! Generated from `tests/parity/scenes/threers-depth-mat.html`.
//! Compare with the JavaScript tab above; adjust imports before copying to `examples/`.
//!
//! ```text
//! cargo run --example depth_mat
//! ```
