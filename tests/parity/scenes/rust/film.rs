//! Parity scene `film` — native Rust (winit + wgpu).
//!
//! Generated from `tests/parity/scenes/threers-film.html`.
//! Compare with the JavaScript tab above; adjust imports before copying to `examples/`.
//!
//! ```text
//! cargo run --example film
//! ```
...
async fn run() {
    ...
    scene.add(Object3D::mesh(Mesh::new(SphereGeometry::new(0.7, 24, 16), BasicMaterial::new(Color::from_hex(0xff6622)).into())));
