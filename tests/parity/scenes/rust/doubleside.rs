//! Parity scene `doubleside` — native Rust (winit + wgpu).
//!
//! Generated from `tests/parity/scenes/threers-doubleside.html`.
//! Compare with the JavaScript tab above; adjust imports before copying to `examples/`.
//!
//! ```text
//! cargo run --example doubleside
//! ```
...
async fn run() {
    ...
    dl.position = Vector3::new(2.0, 1.0, 3.0);
    scene.add(dl);
