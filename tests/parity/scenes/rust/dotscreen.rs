//! Parity scene `dotscreen` — native Rust (winit + wgpu).
//!
//! Generated from `tests/parity/scenes/threers-dotscreen.html`.
//! Compare with the JavaScript tab above; adjust imports before copying to `examples/`.
//!
//! ```text
//! cargo run --example dotscreen
//! ```
...
async fn run() {
    ...
    scene.background = Color::from_hex(0x334455);
    scene.add(Object3D::mesh(Mesh::new(TorusKnotGeometry::new(0.5, 0.15, 64.0, 8.0), BasicMaterial::new(Color::from_hex(0xaaccff)).into())));
