//! Parity scene `fxaa` — native Rust (winit + wgpu).
//!
//! Generated from `tests/parity/scenes/threers-fxaa.html`.
//! Compare with the JavaScript tab above; adjust imports before copying to `examples/`.
//!
//! ```text
//! cargo run --example fxaa
//! ```
...
async fn run() {
    ...
    let mut cube = Object3D::mesh(Mesh::new(BoxGeometry::new(0.8, 0.8, 0.8), BasicMaterial::new(Color::from_hex(0xffffff)).into()));
