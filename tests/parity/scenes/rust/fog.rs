//! Parity scene `fog` — native Rust (winit + wgpu).
//!
//! Generated from `tests/parity/scenes/threers-fog.html`.
...
async fn run() {
    ...
    scene.fog = FogParams { color: Color::from_hex(0x88aacc), near: 2, far: 12, mode: 1, ..Default::default() };
    // i < 3;
