import { BufferAttribute } from '/web/threejs-shim.js';
...
export function ensureIndex( geo, options ) {
	...
	if ( ! geo.index ) {
		...
		// JS-only index; wasm sync happens later in MeshBVH._syncGeometryWasm.
		geo._indexAttr = new BufferAttribute( index, 1 );
